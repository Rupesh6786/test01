...
import { Building2, ListChecks, UserCircle, LogOut, Loader2, PlusCircle, Pencil, Trash2, Home, Briefcase, MapPin, CalendarDays, Clock, CreditCard } from "lucide-react";
...
import { collection, query, onSnapshot, Unsubscribe, doc, deleteDoc, updateDoc, orderBy } from "firebase/firestore";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
export default function MyAccountPage() {
  ...
  const handlePayForAppointment = useCallback(async (appointment: Appointment) => {
    ...
    const options: RazorpayOptions = {
      key: RAZORPAY_KEY_ID,
      amount: APPOINTMENT_FIXED_PAY_AMOUNT, // Use fixed amount in paise
      currency: "INR",
      ...
      <div className="grid md:grid-cols-3 gap-8">
        <Card className="md:col-span-1">
          ...
          <CardContent className="space-y-2">
            ...
            <Button variant="link" className="p-0 h-auto" onClick={handleEditProfileClick}>Edit Profile</Button>
          </CardContent>
        </Card>
